...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='infogan', help='one of `cgan` and `infogan`.')
    ...
    parser.add_argument('--out_dir', type=str, default='output_fashion', help='Directory for output.')
